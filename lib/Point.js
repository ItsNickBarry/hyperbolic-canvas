...
(function () {
  ...
  */
  ...
  //   var dir;
  //
  //   var thisOpposite = thisAngle + Math.PI;
  //   if (thisOpposite > Math.TAU) {
  //     thisOpposite %= Math.TAU;
  //   }
  ...
  //     gamma = Math.PI;
  //   }
  //   return Point.fromHyperbolicPolarCoordinates(a, thisAngle + gamma * dir);//(difference < Math.PI ? 1 : -1)
  // };
