...
(function () {
  ...
  Point.prototype.hyperbolicDistantPoint = function (distance, direction) {
    ...
    */
    ...
    var hyperbolicDistantPoint = Point.givenHyperbolicPolarCoordinates(a, bAngle);
    ...
    hyperbolicDistantPoint.setDirection(
      HyperbolicCanvas.Angle.opposite(hyperbolicDistantPoint.hyperbolicAngleTo(this))
    );

    return hyperbolicDistantPoint;
  };
