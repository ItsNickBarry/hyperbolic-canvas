 ...
 */
  ...
  */
  ...
  Canvas.prototype.drawLine = function (p1, p2, infinite) {
    ...
    var m = Line.pointPoint(new Point(0, 0), p1).perpindicularSlope();

    var l1 = Line.pointSlope(p1, m);

    var circleIntersects = l1.unitCircleIntersects();
    // l1 intersects unit circle at X and Y
    // tangents of unit circle at X and Y meet at c

    //get point c

    //circle
    var circle = Circle.pointPointPoint(p1, p2, c);
  ...
  Canvas.prototype.distanceFromCenter = function (p) {
    ...
    var r = Line.pointPoint(new Point(0, 0), p).euclideanDistance();
