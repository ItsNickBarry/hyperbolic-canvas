...
(function () {
  ...
  Line.prototype._calculateGeodesicThroughTwoIdealPoints = function () {
    ...
    if (Math.abs(a0 - HyperbolicCanvas.Angle.opposite(a1)) < 1e-6) {
      ...
      var t0 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(this.getP0());
      var t1 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(this.getP1());
  ...
  Line.prototype._calculateGeodesicThroughOnePointOnPlane = function () {
    ...
    var t0 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(intersects[0]);
    var t1 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(intersects[1]);
