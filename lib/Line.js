...
(function () {
  ...
  Line.prototype.getArc = function () {
    ...
    if (typeof this._geodesic === 'undefined') {
      ...
      // get the line either point, which is perpindicular to origin
      var l = l0.perpindicularLineAt(this.getP0());

      // get the intersects of line with unit circle
      var intersects = l.getUnitCircleIntersects();
