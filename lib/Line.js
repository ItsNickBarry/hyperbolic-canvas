...
(function () {
  ...
  Line.prototype.getArc = function () {
    ...
    if (typeof this._geodesic === 'undefined') {
      if (this.getP0().isIdeal() || this.getP1().isIdeal()) {
        ...
        // either Point is at origin, so geodesic is not a Circle
        // TODO should this return a Line?
        this._geodesic = false;
      } else {
  ...
  Line.givenAnglesOfIdealPoints = function (a0, a1) {
    return new Line({
      p0: HyperbolicCanvas.Circle.UNIT.hyperbolicPointAt(a0),
      p1: HyperbolicCanvas.Circle.UNIT.hyperbolicPointAt(a1)
    });
  };
