...
(function () {
  ...
  */
  var Line = window.HyperbolicCanvas.Line = function (options) {
    ...
    if (!this.p0 ^ !this.p1) {
      if (this.slope != undefined) {
        ...
        this.p1 = Point.xY(0, this.p0.y - this.slope * this.p0.x);
      } else {
  ...
  Line.hyperbolicIntersect = function (l0, l1) {
    ...
    var d0 = Line.pointPoint(intersects[0], Point.CENTER).euclideanDistance();
    var d1 = Line.pointPoint(intersects[1], Point.CENTER).euclideanDistance();
