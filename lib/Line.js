...
(function () {
  ...
  Line.prototype.hyperbolicDistance = function () {
    ...
    // TODO if one of the points is close enough to the border, it is considered equal to the intersect, and breaks this
  ...
  Line.fromTwoPoints = function (p0, p1) {
    ...
    return new Line({ p0: p0, p1: p1, slope: (Math.abs(m) === Infinity ? Infinity : m) });
  };
})();
