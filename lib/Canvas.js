...
(function () {
  ...
  //
  //   for (var i = 0; i < n; i++) {
  //     var l = Line.fromTwoPoints(vertices[i], vertices[(i + 1) % n]);
  //     var p0 = this.at(l.p0);
  //     this.ctx.lineTo(p0[0], p0[1]); // TODO why is this lineTo necessary?
  //     var p1 = this.at(l.p1);
  //     var c = l.arcCircle();
  //     if (!c) {
  //       this.ctx.lineTo(p1[0], p1[1]);
