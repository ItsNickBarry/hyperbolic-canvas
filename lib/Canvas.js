...
(function () {
  ...
  Canvas.prototype.strokeLineThroughIdealPoints = function (a0, a1) {
    ...
    var l0 = Line.fromPointSlope(p0, -1 / Angle.slope(a0));
    var l1 = Line.fromPointSlope(p1, -1 / Angle.slope(a1));

    var center = Line.intersect(l0, l1);
    var circle = Circle.fromCenterRadius(center, Line.fromTwoPoints(p0, center).euclideanDistance());
