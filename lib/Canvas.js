...
(function () {
  ...
  Canvas.prototype.strokeLineThroughIdealPoints = function (t1, t2) {
  ...
  Canvas.prototype.strokeGrid = function (n) {
    ...
    for (var i = 1; i < divs; i++) {
      // x axis
      this.ctx.moveTo(this.diameter * i / divs, 0);
      this.ctx.lineTo(this.diameter * i / divs, this.diameter);
      // y axis
      this.ctx.moveTo(0, this.diameter * i / divs);
      this.ctx.lineTo(this.diameter, this.diameter * i / divs);
    }
    this.ctx.stroke();
    this.ctx.closePath();
  };
  ...
  Canvas.prototype.fillAndStrokeCircle = function (c) {
    this.drawCircle(c, { fill: true, stroke: true });
  };

  Canvas.prototype.fillCircle = function (c) {
    this.drawCircle(c, { fill: true });
  };

  Canvas.prototype.strokeCircle = function (c) {
    this.drawCircle(c, { stroke: true });
  };
  ...
  Canvas.prototype.fillAndStrokePolygon = function (p) {
    this.drawPolygon(p, { fill: true, stroke: true });
  };

  Canvas.prototype.fillPolygon = function (p) {
    this.drawPolygon(p, { fill: true });
  };

  Canvas.prototype.strokePolygon = function (p) {
    this.drawPolygon(p, { stroke: true });
  };
