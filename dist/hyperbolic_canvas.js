(function (f) {
  ...
  })()(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          Angle.random = function (quadrant) {
            ...
            return quadrant
              ? angle / 4 + (Math.PI / 2) * ((quadrant - 1) % 4)
              : angle;
          };
      ...
      3: [
        function (require, module, exports) {
          ...
          Canvas.prototype.pathForReferenceAngles = function (
            n,
            rotation,
            options,
          ) {
          ...
          Canvas.prototype._pathForHyperbolicLine = function (
            l,
            path,
            options,
          ) {
          ...
          Canvas.prototype._pathForHyperbolicPolygon = function (
            p,
            path,
            options,
          ) {
            ...
            if (options.infinite) {
              for (let i = 0; i < lines.length; i++) {
                this._pathForHyperbolicLine(
                  lines[i].getIdealLine(),
                  path,
                  options,
                );
              }
              ...
              for (let i = 0; i < lines.length; i++) {
                this._pathForHyperbolicLine(lines[i], path, {
                  connected: true,
                });
              }
            }
        ...
        function (require, module, exports) {
          ...
          Circle.prototype.getEuclideanArea = function () {
            if (typeof this._euclideanArea === 'undefined') {
              this._euclideanArea =
                Math.PI * Math.pow(this.getEuclideanRadius(), 2);
            }
          ...
          Circle.prototype.getEuclideanCircumference = function () {
            if (typeof this._euclideanCircumference === 'undefined') {
              this._euclideanCircumference =
                Math.TAU * this.getEuclideanRadius();
            }
          ...
          Circle.prototype.equals = function (otherCircle) {
            return (
              this.getEuclideanCenter().equals(
                otherCircle.getEuclideanCenter(),
              ) &&
              Math.abs(
          ...
          Circle.prototype._pythagoreanTheorem = function (b) {
            ...
            return Math.abs(aSquared) < HyperbolicCanvas.ZERO
              ? 0
              : Math.sqrt(aSquared);
          };
          ...
          Circle.prototype._calculateEuclideanCenterRadius = function () {
            ...
            let diameter = HyperbolicCanvas.Line.givenTwoPoints(
              farPoint,
              nearPoint,
            );
          ...
          Circle.intersects = function (c0, c1) {
            ...
            let p1 = HyperbolicCanvas.Point.givenCoordinates(
              xi_prime,
              yi_prime,
            );
          ...
          Circle.UNIT.getEuclideanCenter = Circle.UNIT.getHyperbolicCenter =
            function () {
          ...
          Circle.UNIT.hyperbolicAngleAt = Circle.UNIT.euclideanAngleAt =
            function (point) {
              return point.getAngle();
            };

          Circle.UNIT.hyperbolicPointAt = Circle.UNIT.euclideanPointAt =
            function (angle) {
      ...
      6: [
        function (require, module, exports) {
          ...
          let Line = (HyperbolicCanvas.Line = function (options) {
            ...
            this._euclideanUnitCircleIntersects =
              options.euclideanUnitCircleIntersects;
          ...
          Line.prototype.getEuclideanLength = function () {
            if (typeof this._euclideanLength === 'undefined') {
              this._euclideanLength = this.getP0().euclideanDistanceTo(
                this.getP1(),
              );
            }
          ...
          Line.prototype.getHyperbolicLength = function () {
            if (typeof this._hyperbolicLength === 'undefined') {
              this._hyperbolicLength = this.getP0().hyperbolicDistanceTo(
                this.getP1(),
              );
            }
          ...
          Line.prototype.euclideanIntersectsWithCircle = function (circle) {
            ...
            let angleOffset =
              HyperbolicCanvas.Angle.fromSlope(this.getSlope()) * -1;

            let offsetCircle =
              HyperbolicCanvas.Circle.givenEuclideanCenterRadius(
          ...
          Line.prototype.euclideanXAtY = function (y) {
            if (this.getSlope() === 0) {
              ...
              return (
                (y - this.getP0().getY()) / this.getSlope() +
                this.getP0().getX()
              );
            }
          };
          ...
          Line.prototype.euclideanYAtX = function (x) {
            if (this.getSlope() === Infinity) {
              ...
              return (
                (x - this.getP0().getX()) * this.getSlope() +
                this.getP0().getY()
              );
            }
          };
          ...
          Line.prototype.isEuclideanParallelTo = function (otherLine) {
            return (
              Math.abs(this.getSlope() - otherLine.getSlope()) <
              HyperbolicCanvas.ZERO
            );
          };
          ...
          Line.prototype.euclideanPerpindicularBisector = function () {
            return this.euclideanPerpindicularLineAt(
          ...
          Line.prototype.euclideanPerpindicularLineAt = function (point) {
            return Line.givenPointSlope(
              point,
              this.euclideanPerpindicularSlope(),
            );
          };
          ...
          Line.prototype._calculateGeodesicThroughTwoIdealPoints = function () {
            ...
            if (
              Math.abs(a0 - HyperbolicCanvas.Angle.opposite(a1)) <
              HyperbolicCanvas.ZERO
            ) {
              this._geodesic = this;
            } else {
          ...
          Line.prototype._calculateGeodesicThroughOnePointOnPlane =
            function () {
              let l0 = Line.givenTwoPoints(
                this.getP0(),
                HyperbolicCanvas.Point.ORIGIN,
              );
              let l1 = Line.givenTwoPoints(
                this.getP1(),
                HyperbolicCanvas.Point.ORIGIN,
              );
          ...
          Line.hyperbolicIntersect = function (l0, l1) {
            ...
            if (g0IsLine || g1IsLine) {
              ...
              let angleOffset =
                HyperbolicCanvas.Angle.fromSlope(line.getSlope()) * -1;
          ...
          Line.randomSlope = function () {
            return HyperbolicCanvas.Angle.toSlope(
          ...
          Line.Y_AXIS = new Line({
            p0: HyperbolicCanvas.Point.ORIGIN,
            m: Infinity,
          });
        },
        { './hyperbolic_canvas.js': 5 },
      ...
      7: [
        function (require, module, exports) {
          ...
          Point.prototype.getHyperbolicRadius = function () {
            if (typeof this._hyperbolicRadius === 'undefined') {
              if (this.isIdeal()) {
                ...
                this._hyperbolicRadius =
                  2 * Math.atanh(this.getEuclideanRadius());
              }
            }
            return this._hyperbolicRadius;
          };
          ...
          Point.prototype.equals = function (otherPoint) {
            return (
              Math.abs(this.getX() - otherPoint.getX()) <
                HyperbolicCanvas.ZERO &&
          ...
          Point.prototype.euclideanDistantPoint = function (
            distance,
            direction,
          ) {
          ...
          Point.prototype.hyperbolicDistantPoint = function (
            distance,
            direction,
          ) {
            /*
  ...
  */
          ...
          Point.ORIGIN.euclideanAngleFrom = Point.ORIGIN.hyperbolicAngleFrom =
            function (otherPoint) {
              return HyperbolicCanvas.Angle.opposite(
                this.euclideanAngleTo(otherPoint),
              );
            };

          Point.ORIGIN.euclideanAngleTo = Point.ORIGIN.hyperbolicAngleTo =
            function (otherPoint) {
      ...
      8: [
        function (require, module, exports) {
          ...
          Polygon.givenEuclideanNCenterRadius = function (
            n,
            center,
            radius,
            rotation,
            ...
            rotation = rotation
              ? HyperbolicCanvas.Angle.normalize(rotation)
              : 0;
          ...
          Polygon.givenHyperbolicNCenterRadius = function (
            n,
            center,
            radius,
            rotation,
