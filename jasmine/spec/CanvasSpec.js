describe('Canvas', function () {
  ...
  describe('when generating path', function () {
    ...
    it(
      'returns CanvasRenderingContext2D by default',
      function () {
        expect(canvas.pathForEuclidean(object)).toBeA(CanvasRenderingContext2D);
        expect(canvas.pathForHyperbolic(object)).toBeA(
    ...
    describe('with Path2D unavailable to current browser', function () {
      ...
      it(
        'returns CanvasRenderingContext2D if Path2D is requested',
        function () {
          var options = { path2D: true, path: false };
          expect(canvas.pathForEuclidean(object, options)).toBeA(
            CanvasRenderingContext2D,
          );
          expect(canvas.pathForHyperbolic(object, options)).toBeA(
            CanvasRenderingContext2D,
          );
        },
        true,
