describe('Jasmine', function () {
  ...
  it(
    'has defined random seed on the Math object',
    function () {
  ...
  it(
    'generates multiple unique numbers for a single spec',
    function () {
  ...
  it(
    'has generated ' + testRunCount + ' numbers with previous spec',
    function () {
