...
Line.prototype._calculateGeodesicThroughTwoIdealPoints = function () {
  ...
  if (
    ...
    let t0 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(this.getP0());
    let t1 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(this.getP1());
...
Line.prototype._calculateGeodesicThroughOnePointOnPlane = function () {
  ...
  let t0 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(intersects[0]);
  let t1 = HyperbolicCanvas.Circle.UNIT.euclideanTangentAtPoint(intersects[1]);
